...
import { BarChart3, Brain, Clock3, Mic, TrendingUp } from "lucide-react";
...
export default function EnglishProgressHub() {
  ...
  return (
    <div className="space-y-6 min-w-0">
      <HubHeader title="学习成长" subtitle="回顾真实学习记录、口语趋势与 AI 总结" onBack={() => navigate("/english")} />

      <section aria-label="学习成长概览" className="grid grid-cols-3 rounded-lg border border-border bg-card py-4">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <HubLink icon={Mic} title="口语记录" description="回到口语中心查看最近练习" onClick={() => navigate("/english/speaking")} />
