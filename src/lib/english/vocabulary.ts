...
export interface VocabularyExtractResult { saved?: number; rejected?: VocabularyReject[]; notes?: { index: number; field: string; detail: string }[]; spans?: number; partial?: boolean }
